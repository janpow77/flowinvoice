...
export const EU_VAT: Ruleset = {
  ...
  features: [
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'IDENTITY',
      explanation_de: 'Umsatzsteuer-Identifikationsnummer des Lieferanten (EU-Format: Ländercode + Nummer)',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'IDENTITY',
      explanation_de: 'Vollständiger Name und Anschrift des Steuerpflichtigen (Lieferant)',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'IDENTITY',
      explanation_de: 'Vollständiger Name und Anschrift des Erwerbers oder Dienstleistungsempfängers',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'TEXT',
      explanation_de: 'Menge und Art der gelieferten Gegenstände bzw. Umfang und Art der Dienstleistungen',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'TAX',
      explanation_de: 'Zu zahlender MwSt-Betrag (außer bei Steuerbefreiung)',
    ...
    },
    {
      ...
      required_level: 'CONDITIONAL',
      category: 'TAX',
      explanation_de: 'Hinweis auf Steuerbefreiung mit Verweis auf die einschlägige Bestimmung',
    ...
    },
    {
      ...
      required_level: 'CONDITIONAL',
      category: 'TAX',
      explanation_de: 'Hinweis "Steuerschuldnerschaft des Leistungsempfängers" bei Reverse Charge',
    ...
    },
    {
      ...
      required_level: 'CONDITIONAL',
      category: 'TAX',
      explanation_de: 'Hinweis auf Differenzbesteuerung (z.B. "Gebrauchtgegenstände / Sonderregelung")',
