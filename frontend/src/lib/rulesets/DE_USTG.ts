...
export const DE_USTG: Ruleset = {
  ...
  title_en: 'Germany – VAT Act (UStG)',
  subtitle_de: 'Pflichtangaben nach § 14 Abs. 4 UStG',
  subtitle_en: 'Mandatory fields per § 14(4) UStG',
  legal_references: [
    {
      law: 'UStG',
      section: '§ 14 Abs. 4',
  ...
  features: [
    {
      ...
      category: 'IDENTITY',
      explanation_de: 'Vollständiger Name und Anschrift des leistenden Unternehmers (Straße, PLZ, Ort)',
    ...
    },
    {
      ...
      name_de: 'Name und Anschrift des Empfängers',
      name_en: 'Customer name and address',
      legal_basis: '§ 14 Abs. 4 Nr. 1 UStG',
      required_level: 'REQUIRED',
      category: 'IDENTITY',
      explanation_de: 'Vollständiger Name und Anschrift des Leistungsempfängers',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'TEXT',
      explanation_de: 'Art (handelsübliche Bezeichnung) und Umfang der Lieferung oder sonstigen Leistung',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'AMOUNT',
      explanation_de: 'Entgelt (Summe ohne Umsatzsteuer), aufgeschlüsselt nach Steuersätzen',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'TAX',
      explanation_de: 'Anzuwendender Steuersatz (19% Regelsteuersatz oder 7% ermäßigt)',
    ...
    },
    {
      ...
      required_level: 'REQUIRED',
      category: 'TAX',
      explanation_de: 'Auf das Entgelt entfallender Steuerbetrag (Netto × Steuersatz)',
    ...
    },
    {
      ...
      category: 'TAX',
      explanation_de: 'Hinweis auf Steuerbefreiung (z.B. "Innergemeinschaftliche Lieferung gemäß § 4 Nr. 1b UStG")',
