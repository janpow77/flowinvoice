...
export const de = {
  ...
  users: {
    ...
    subtitle: 'Verwalten Sie Benutzer, Rollen und Berechtigungen',
    ...
    save: 'Speichern',
    delete: 'Löschen',
    searchPlaceholder: 'Suche nach Name, E-Mail oder Benutzername...',
    ...
    deleteConfirmation: 'Möchten Sie den Benutzer "{{username}}" wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.',
    resetPassword: 'Passwort zurücksetzen',
    resetPasswordConfirm: 'Passwort zurücksetzen',
    resetPasswordDescription: 'Geben Sie ein neues Passwort für "{{username}}" ein.',
  ...
  projectDetail: {
    ...
    showLegalReferences: 'Rechtsgrundlagen anzeigen',
    showSpecialRules: 'Sonderregeln anzeigen',
    smallAmountInvoice: 'Kleinbetragsrechnung',
    smallAmountThreshold: 'Schwellenwert',
    smallAmountDescription: 'Bei Rechnungen unter diesem Betrag gelten vereinfachte Anforderungen an Pflichtangaben.',
    reducedFieldsLabel: 'Reduzierte Pflichtangaben bei Kleinbetragsrechnungen:',
    showCheckers: 'Prüfmodule anzeigen',
    checkerActive: 'Aktiv',
    checkerInactive: 'Inaktiv',
    checkerPeriod: 'Projektzeitraum-Prüfung',
    checkerPeriodDesc: 'Prüft ob das Leistungsdatum innerhalb des Projektzeitraums liegt.',
    checkerRisk: 'Risiko-Prüfung',
    riskSelfInvoice: 'Selbstrechnung',
    riskDuplicate: 'Doppelte Rechnungen',
    riskRoundAmounts: 'Runde Beträge',
    riskWeekend: 'Wochenend-Daten',
    checkerSemantic: 'Semantik-Prüfung',
    semanticRelevance: 'Projektrelevanz',
    semanticDescription: 'Beschreibungsqualität',
    semanticRag: 'RAG-Kontext verwenden',
    checkerEconomic: 'Wirtschaftlichkeits-Prüfung',
    economicBudget: 'Budgetgrenzen',
    economicPrices: 'Einzelpreise',
    economicFunding: 'Förderquote',
  ...
  settings: {
    ...
    examples: 'Beispiele',
    // RAG Restrictions
    ragRestrictions: 'RAG-Einschränkungen',
    maxExamples: 'Maximale Beispiele',
    maxExamplesDescription: 'Maximale Anzahl der RAG-Beispiele pro Analyse (1-5)',
    sameDocumentType: 'Gleicher Dokumenttyp',
    sameDocumentTypeDescription: 'Nur Beispiele vom gleichen Dokumenttyp verwenden',
    sameRuleset: 'Gleiches Regelwerk',
    sameRulesetDescription: 'Nur Beispiele vom gleichen Regelwerk verwenden',
