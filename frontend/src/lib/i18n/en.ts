...
export const en = {
  ...
  users: {
    ...
    deleteConfirmation: 'Are you sure you want to delete the user "{{username}}"? This action cannot be undone.',
  ...
  documentDetail: {
    ...
    assessmentOk: 'OK',
    assessmentReview: 'Review needed',
    assessmentRejected: 'Rejected',
    confidence: 'Confidence',
    extractedData: 'Extracted Data',
    correctionsCount: '{{count}} correction(s)',
    showLess: 'Show less',
    ...
    feedback: {
      confirmed: 'Feedback sent - Result confirmed',
      correctionsSent: 'Feedback sent - {{count}} correction(s) submitted',
      editHint: 'Edit the fields and save your corrections.',
      saveCorrections: 'Save {{count}} correction(s)',
      confirmCorrect: 'Confirm as correct',
      question: 'Was this analysis correct?',
  ...
  settings: {
    ...
    examples: 'examples',
    // RAG Restrictions
    ragRestrictions: 'RAG Restrictions',
    maxExamples: 'Maximum Examples',
    maxExamplesDescription: 'Maximum number of RAG examples per analysis (1-5)',
    sameDocumentType: 'Same Document Type',
    sameDocumentTypeDescription: 'Only use examples from the same document type',
    sameRuleset: 'Same Ruleset',
    sameRulesetDescription: 'Only use examples from the same ruleset',
  ...
  checkResults: {
    ...
    noResults: 'No extended check results available',
    ...
    grantPurpose: {
      ...
      organizationalRelation: 'Organizational relation',
      economicPlausibility: 'Economic plausibility',
    },
    conflicts: {
      title: 'Conflict Resolution',
      count: '{{count}} conflict(s)',
      rule: 'Rule',
      ai: 'AI',
