...
def _generate_invoice_data(
    ...
    templates_config = {
        ...
        "T6_BAUGEWERBE": {
            ...
            "position_count_range": (5, 15),
            "positions": [
                {"description": "Mauerarbeiten", "unit": "m²", "price_range": (45, 85)},
                {"description": "Betonarbeiten", "unit": "m³", "price_range": (120, 220)},
                {"description": "Erdarbeiten/Aushub", "unit": "m³", "price_range": (25, 55)},
                {"description": "Estricharbeiten", "unit": "m²", "price_range": (18, 35)},
                {"description": "Putzarbeiten Innen", "unit": "m²", "price_range": (12, 28)},
                {"description": "Putzarbeiten Außen", "unit": "m²", "price_range": (22, 45)},
                {"description": "Trockenbau/Rigips", "unit": "m²", "price_range": (35, 65)},
                {"description": "Fliesenarbeiten", "unit": "m²", "price_range": (55, 95)},
                {"description": "Dachdeckerarbeiten", "unit": "m²", "price_range": (65, 120)},
                {"description": "Zimmererarbeiten", "unit": "Std.", "price_range": (55, 85)},
                {"description": "Gerüststellung", "unit": "m²/Monat", "price_range": (8, 18)},
                {"description": "Bauschutt-Entsorgung", "unit": "Container", "price_range": (250, 450), "qty_range": (1, 3)},
                {"description": "Baustelleneinrichtung", "unit": "Pausch.", "price_range": (500, 1500), "qty_range": (1, 1)},
                {"description": "Bauhelfer", "unit": "Std.", "price_range": (28, 42)},
                {"description": "Kranstellung", "unit": "Tag", "price_range": (350, 800)},
            ],
        },
        "T7_FORSCHUNG": {
            ...
            "position_count_range": (3, 10),
            "positions": [
                {"description": "Spektrometer UV-VIS", "unit": "Stk.", "price_range": (8000, 25000), "qty_range": (1, 2)},
                {"description": "Mikroskop Forschungsklasse", "unit": "Stk.", "price_range": (5000, 35000), "qty_range": (1, 2)},
                {"description": "Zentrifuge Hochgeschwindigkeit", "unit": "Stk.", "price_range": (3000, 12000), "qty_range": (1, 2)},
                {"description": "Pipettiersystem automatisch", "unit": "Stk.", "price_range": (2500, 8000), "qty_range": (1, 3)},
                {"description": "Laborwaage Präzision", "unit": "Stk.", "price_range": (800, 4500), "qty_range": (1, 3)},
                {"description": "pH-Messgerät Labor", "unit": "Stk.", "price_range": (350, 1200), "qty_range": (1, 5)},
                {"description": "Magnetrührer mit Heizung", "unit": "Stk.", "price_range": (180, 650), "qty_range": (1, 5)},
                {"description": "Laborkühlschrank -20°C", "unit": "Stk.", "price_range": (1200, 3500), "qty_range": (1, 2)},
                {"description": "Sterilwerkbank Klasse II", "unit": "Stk.", "price_range": (6000, 18000), "qty_range": (1, 2)},
                {"description": "Laborglaswaren-Set", "unit": "Set", "price_range": (250, 800), "qty_range": (1, 5)},
                {"description": "Chemikalien-Grundausstattung", "unit": "Pausch.", "price_range": (500, 2500), "qty_range": (1, 1)},
                {"description": "Laborverbrauchsmaterial", "unit": "Pausch.", "price_range": (200, 1000), "qty_range": (1, 3)},
                {"description": "Kalibrierservice", "unit": "Gerät", "price_range": (150, 450)},
                {"description": "Einweisung/Schulung", "unit": "Std.", "price_range": (95, 180)},
            ],
        },
        "T8_IT_HARDWARE": {
            ...
            "position_count_range": (4, 12),
            "positions": [
                {"description": "Workstation PC High-End", "unit": "Stk.", "price_range": (1800, 4500), "qty_range": (1, 10)},
                {"description": "Notebook Business-Klasse", "unit": "Stk.", "price_range": (900, 2200), "qty_range": (1, 20)},
                {"description": "Monitor 27\" 4K", "unit": "Stk.", "price_range": (350, 800), "qty_range": (1, 20)},
                {"description": "Monitor 32\" Curved", "unit": "Stk.", "price_range": (450, 1100), "qty_range": (1, 10)},
                {"description": "Server Rack 2HE", "unit": "Stk.", "price_range": (3500, 12000), "qty_range": (1, 5)},
                {"description": "NAS Storage 8-Bay", "unit": "Stk.", "price_range": (1200, 3500), "qty_range": (1, 3)},
                {"description": "SSD NVMe 1TB", "unit": "Stk.", "price_range": (80, 180), "qty_range": (1, 50)},
                {"description": "RAM DDR5 32GB Kit", "unit": "Stk.", "price_range": (120, 280), "qty_range": (1, 30)},
                {"description": "Netzwerk-Switch 24-Port", "unit": "Stk.", "price_range": (250, 1200), "qty_range": (1, 5)},
                {"description": "WLAN Access Point", "unit": "Stk.", "price_range": (150, 450), "qty_range": (1, 10)},
                {"description": "USV 1500VA", "unit": "Stk.", "price_range": (350, 900), "qty_range": (1, 5)},
                {"description": "Tastatur/Maus-Set", "unit": "Set", "price_range": (45, 150), "qty_range": (1, 30)},
                {"description": "Netzwerkkabel Cat6a", "unit": "m", "price_range": (1.5, 4)},
                {"description": "Patchkabel Cat6a 2m", "unit": "Stk.", "price_range": (5, 15), "qty_range": (10, 100)},
                {"description": "Kabelkanal/Kabelmanagement", "unit": "m", "price_range": (8, 25)},
                {"description": "Installation & Einrichtung", "unit": "Std.", "price_range": (85, 140)},
            ],
        },
        "T9_INDUSTRIE": {
            ...
            "position_count_range": (5, 15),
            "positions": [
                {"description": "Drucksensor 0-10bar", "unit": "Stk.", "price_range": (85, 350), "qty_range": (1, 20)},
                {"description": "Temperatursensor PT100", "unit": "Stk.", "price_range": (45, 180), "qty_range": (1, 30)},
                {"description": "Durchflusssensor DN25", "unit": "Stk.", "price_range": (250, 800), "qty_range": (1, 10)},
                {"description": "Füllstandssensor kapazitiv", "unit": "Stk.", "price_range": (120, 450), "qty_range": (1, 15)},
                {"description": "Näherungssensor induktiv", "unit": "Stk.", "price_range": (35, 120), "qty_range": (1, 50)},
                {"description": "Kreiselpumpe 5,5kW", "unit": "Stk.", "price_range": (1200, 3500), "qty_range": (1, 5)},
                {"description": "Dosierpumpe Membran", "unit": "Stk.", "price_range": (450, 1500), "qty_range": (1, 8)},
                {"description": "Tauchpumpe Edelstahl", "unit": "Stk.", "price_range": (350, 1200), "qty_range": (1, 5)},
                {"description": "Edelstahlrohr DN50", "unit": "m", "price_range": (35, 85)},
                {"description": "PE-Rohr DN32", "unit": "m", "price_range": (8, 22)},
                {"description": "Kupferrohr 28mm", "unit": "m", "price_range": (18, 35)},
                {"description": "Rohrverschraubung Edelstahl", "unit": "Stk.", "price_range": (15, 65), "qty_range": (5, 50)},
                {"description": "Kugelhahn DN40", "unit": "Stk.", "price_range": (45, 180), "qty_range": (1, 20)},
                {"description": "Steuerkabel 4x1,5mm²", "unit": "m", "price_range": (2, 6)},
                {"description": "Datenkabel geschirmt", "unit": "m", "price_range": (3, 8)},
                {"description": "Energiekabel NYY 5x6mm²", "unit": "m", "price_range": (8, 18)},
                {"description": "Schaltschrank IP65", "unit": "Stk.", "price_range": (350, 1200), "qty_range": (1, 5)},
                {"description": "SPS-Modul Digital I/O", "unit": "Stk.", "price_range": (180, 550), "qty_range": (1, 10)},
                {"description": "Frequenzumrichter 7,5kW", "unit": "Stk.", "price_range": (650, 1800), "qty_range": (1, 5)},
                {"description": "Montage Industrieanlagen", "unit": "Std.", "price_range": (65, 95)},
            ],
        },
    }
