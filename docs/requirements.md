...
## 12. Informations- & Statistik-Dashboard (Pflicht)

### 12.1 Dashboard-Übersicht (Hauptseite)

```
┌─────────────────────────────────────────────────────────────────────────────┐
│  📊 FlowAudit – Statistik & Information                                     │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  ── Schnellübersicht ───────────────────────────────────────────────────── │
│                                                                              │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐             │
│  │  Dokumente      │  │  Feedback       │  │  RAG-Beispiele  │             │
│  │      127        │  │      89         │  │       42        │             │
│  │  analysiert     │  │  abgegeben      │  │  gelernt        │             │
│  └─────────────────┘  └─────────────────┘  └─────────────────┘             │
│                                                                              │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐             │
│  │  Ø Laufzeit     │  │  Fehlerquote    │  │  Aktiver        │             │
│  │    12.3s        │  │    14.2%        │  │  Provider       │             │
│  │  pro Dokument   │  │  (vor Feedback) │  │  Ollama (lokal) │             │
│  └─────────────────┘  └─────────────────┘  └─────────────────┘             │
│                                                                              │
│  [ Analysen ]  [ Feedback ]  [ Modelle ]  [ RAG/Lernen ]  [ System ]       │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```

### 12.2 Tab: Analysen-Statistik
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  Zeitraum: [ Letzte 7 Tage ▼ ]  [ Alle Projekte ▼ ]  [ Alle Provider ▼ ]   │
│                                                                              │
│  ── Gesamtübersicht ─────────────────────────────────────────────────────  │
│                                                                              │
│  │ Dokumente analysiert      │    127     │ +23 diese Woche              │ │
│  │ Erfolgreiche Analysen     │    119     │ 93.7%                        │ │
│  │ Fehlerhafte Analysen      │      8     │ Parser: 5, LLM: 3            │ │
│  │ Durchschnittliche Laufzeit│   12.3s    │ Parser: 1.8s, LLM: 10.5s     │ │
│  │ Gesamte Verarbeitungszeit │   26 Min   │                              │ │
│                                                                              │
│  ── Nach Provider ───────────────────────────────────────────────────────  │
│                                                                              │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Provider       │ Analysen │ Ø Zeit  │ Ø Tokens │ Fehlerquote        │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ Ollama (lokal) │     89   │  15.2s  │   2.100  │    12.4%           │  │
│  │ OpenAI         │     25   │   4.8s  │   1.850  │    16.0%           │  │
│  │ Claude         │     13   │   6.2s  │   2.300  │    15.4%           │  │
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
│  ── Laufzeit-Trend (Diagramm) ──────────────────────────────────────────   │
│                                                                              │
│      20s │     ·                                                            │
│      15s │  ·  ·  ·     ·                                                  │
│      10s │        ·  ·  ·  ·  ·  ·                                         │
...
│                                                                              │
│  │ Feedback gesamt           │     89     │                              │ │
│  │ ✓ Korrekt (akzeptiert)    │     52     │ 58.4%   ████████████░░░░░░  │ │
│  │ ~ Teilweise korrekt       │     28     │ 31.5%   ██████░░░░░░░░░░░░  │ │
│  │ ✗ Falsch (korrigiert)     │      9     │ 10.1%   ██░░░░░░░░░░░░░░░░  │ │
│                                                                              │
│  ── Fehler nach Merkmal (Feature) ───────────────────────────────────────  │
│                                                                              │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Merkmal                      │ Fehler │ Anteil │ Trend              │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ supplier_tax_or_vat_id       │   18   │ 32.1%  │ ↓ verbessert       │  │
│  │ supply_date_or_period        │   14   │ 25.0%  │ → stabil           │  │
│  │ supply_description           │    9   │ 16.1%  │ ↓ verbessert       │  │
│  │ customer_name_address        │    8   │ 14.3%  │ ↑ verschlechtert   │  │
...
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ 📜 STEUERRECHT (UStG/VAT/MwStSystRL)  │   34   │ 60.7%  │ [Detail] │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
...
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
│  ── Detail: Steuerrechtliche Pflichtangaben (aufklappbar) ───────────────  │
│                                                                              │
│  ▼ 📜 STEUERRECHT – Detailansicht (34 Fehler)                              │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Pflichtangabe              │ Rechtsgrundlage    │ Fehler │ Typ      │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ Steuer-/USt-ID Lieferant   │ §14(4) Nr.2 UStG   │   18   │          │  │
│  │   ├─ MISSING               │                    │   11   │ fehlend  │  │
│  │   ├─ WRONG_FORMAT          │                    │    4   │ Format   │  │
│  │   └─ CONFUSED_WITH_OTHER   │                    │    3   │ Verwechs.│  │
│  │       └─ "Kundennr. statt Steuer-ID erkannt"                        │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ Steuerbetrag (MwSt)        │ §14(4) Nr.7 UStG   │    7   │          │  │
│  │   ├─ CALCULATION_ERROR     │                    │    4   │ Rechnung │  │
│  │   │   └─ "Rundungsdifferenz > 0.01€"                                │  │
│  │   ├─ MISSING               │                    │    2   │ fehlend  │  │
│  │   └─ WRONG_RATE            │                    │    1   │ Satz     │  │
│  │       └─ "19% statt 7% erkannt"                                     │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ Rechnungsnummer            │ §14(4) Nr.4 UStG   │    5   │          │  │
│  │   ├─ MISSING               │                    │    2   │ fehlend  │  │
│  │   ├─ NOT_UNIQUE            │                    │    2   │ Duplikat │  │
│  │   └─ WRONG_FORMAT          │                    │    1   │ Format   │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ Leistungszeitraum/-datum   │ §14(4) Nr.6 UStG   │    4   │          │  │
│  │   ├─ UNCLEAR               │                    │    2   │ unklar   │  │
│  │   │   └─ "Zeitraum nicht eindeutig interpretierbar"                 │  │
│  │   ├─ MISSING               │                    │    1   │ fehlend  │  │
│  │   └─ OUT_OF_PROJECT_PERIOD │                    │    1   │ Zeitraum │  │
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
│  Legende Fehlertypen:                                                       │
│  • MISSING: Pflichtangabe fehlt komplett                                    │
│  • WRONG_FORMAT: Format entspricht nicht Vorgabe                            │
│  • CONFUSED_WITH_OTHER: Verwechslung mit anderem Feld                       │
│  • CALCULATION_ERROR: Rechenfehler (Netto + MwSt ≠ Brutto)                  │
│  • UNCLEAR: Angabe vorhanden, aber nicht eindeutig                          │  │
│                                                                              │
│  ── Verbesserung durch RAG ──────────────────────────────────────────────  │
│                                                                              │
│  Fehlerquote ohne RAG:    22.4%                                            │
│  Fehlerquote mit RAG:     14.2%    ⬇️ 36.6% Verbesserung                   │
│                                                                              │
│  [ Details exportieren (CSV) ]                                             │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  🤖 Lokales Modell – Telemetrie                                             │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  ── Aktives Modell ──────────────────────────────────────────────────────  │
│                                                                              │
│  Modell:       llama3.1:8b-instruct-q4                                      │
│  Provider:     Ollama (lokal)                                               │
│  Status:       ● Geladen und bereit                                         │
│  GPU:          NVIDIA RTX 3060 (12 GB VRAM)                                 │
│                                                                              │
│  ── Ressourcenverbrauch (letzte Analyse) ────────────────────────────────  │
│                                                                              │
│  │ Tokens (Input)            │    2.134   │                              │ │
│  │ Tokens (Output)           │      648   │                              │ │
│  │ Tokens/Sekunde            │     42.3   │                              │ │
│  │ Laufzeit LLM              │   15.2s    │                              │ │
│  │ CPU-Auslastung (Peak)     │     78%    │ ████████████████░░░░        │ │
│  │ RAM-Auslastung (Peak)     │   18.4 GB  │ █████████████░░░░░░░        │ │
│  │ GPU-Auslastung (Peak)     │     92%    │ ██████████████████░░        │ │
│  │ VRAM-Auslastung           │    9.2 GB  │ ███████████████░░░░░        │ │
│                                                                              │
│  ── Durchschnittswerte (letzte 50 Analysen) ─────────────────────────────  │
│                                                                              │
│  │ Ø Tokens Input            │    1.980   │                              │ │
│  │ Ø Tokens Output           │      612   │                              │ │
│  │ Ø Tokens/Sekunde          │     38.7   │                              │ │
│  │ Ø Laufzeit                │   14.8s    │                              │ │
│  │ Ø CPU                     │     65%    │                              │ │
│  │ Ø RAM                     │   16.2 GB  │                              │ │
│                                                                              │
...
│                                                                              │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Modell                │ Analysen │ Ø Zeit │ Fehlerquote │ Ø Tokens  │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ llama3.1:8b (aktuell) │    89    │ 15.2s  │   12.4%     │   2.100   │  │
│  │ mistral:7b            │    34    │ 12.8s  │   18.2%     │   1.850   │  │
│  │ flowaudit-ft-v1       │    12    │ 14.1s  │    8.3%     │   2.050   │  │
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```

### 12.5 Tab: RAG/Lernen (ChromaDB-Übersicht)

```
┌─────────────────────────────────────────────────────────────────────────────┐
│  🧠 RAG – Gelerntes Wissen (ChromaDB)                                       │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  ── Übersicht ───────────────────────────────────────────────────────────  │
│                                                                              │
│  │ Gespeicherte Beispiele    │     42     │                              │ │
│  │ Beispiele diese Woche     │      7     │ +20%                         │ │
│  │ Durchschn. Ähnlichkeit    │    0.68    │ bei Retrieval                │ │
│  │ Beispiele verwendet       │    156×    │ in letzten 50 Analysen       │ │
│                                                                              │
│  ── Nach Ruleset ────────────────────────────────────────────────────────  │
│                                                                              │
│  │ 🇩🇪 DE_USTG               │     28     │ 66.7%                        │ │
...
│  │ 🇬🇧 UK_VAT                 │      4     │  9.5%                        │ │
│                                                                              │
│  ── Meistkorrigierte Merkmale ───────────────────────────────────────────  │
│                                                                              │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Merkmal                      │ Beispiele │ Typische Korrektur        │  │
│  ├──────────────────────────────────────────────────────────────────────┤  │
│  │ supplier_tax_or_vat_id       │    12     │ PRESENT → MISSING         │  │
│  │ supply_date_or_period        │     9     │ UNCLEAR → PRESENT         │  │
│  │ supply_description           │     8     │ Semantik verbessert       │  │
│  │ vat_amount                   │     6     │ Rundungsfehler korrigiert │  │
│  │ customer_name_address        │     4     │ Alias erkannt             │  │
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
│  ── Beispiel-Details (erweiterbar) ──────────────────────────────────────  │
│                                                                              │
│  ▼ Beispiel #RAG-042 (12.12.2025, supplier_tax_or_vat_id)                  │
│  ┌──────────────────────────────────────────────────────────────────────┐  │
│  │ Situation:    Handwerkerrechnung mit Kundennummer statt Steuer-ID   │  │
│  │ LLM sagte:    PRESENT (Wert: "K-4711")                               │  │
│  │ Korrektur:    MISSING                                                 │  │
│  │ Begründung:   "K-4711 ist Kundennummer, nicht Steuernummer"         │  │
│  │ Verwendet:    8× in ähnlichen Fällen                                 │  │
│  │ Effektivität: ✓ 7 von 8 danach korrekt                               │  │
│  └──────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
│  ▶ Beispiel #RAG-041 (11.12.2025, supply_date_or_period)                   │
│  ▶ Beispiel #RAG-040 (10.12.2025, supply_description)                      │
│  ▶ Beispiel #RAG-039 (10.12.2025, vat_amount)                              │
│                                                                              │
│  [ Alle anzeigen ]  [ Exportieren (JSON) ]  [ Statistik neu berechnen ]    │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```

### 12.6 Tab: System-Information
...
│  ── Komponenten-Status ──────────────────────────────────────────────────  │
│                                                                              │
│  │ Backend (FastAPI)         │ ● Online  │ v1.0.0  │ Port 8000           │ │
│  │ Datenbank (PostgreSQL)    │ ● Online  │ v16.1   │ 127 Dokumente       │ │
│  │ Redis (Queue)             │ ● Online  │ v7.2    │ 0 wartende Tasks    │ │
│  │ ChromaDB (Vector Store)   │ ● Online  │ v0.4.22 │ 42 Embeddings       │ │
│  │ Ollama (LLM)              │ ● Online  │ v0.1.32 │ Modell geladen      │ │
│                                                                              │
│  ── Speicherplatz ───────────────────────────────────────────────────────  │
│                                                                              │
│  │ Uploads (/data/uploads)   │  2.3 GB   │ von 20 GB  │ ███░░░░░░░░░░░  │ │
│  │ Exporte (/data/exports)   │  0.8 GB   │ von 10 GB  │ █░░░░░░░░░░░░░  │ │
│  │ ChromaDB (/data/chroma)   │  0.4 GB   │ von  5 GB  │ █░░░░░░░░░░░░░  │ │
│  │ Datenbank                 │  1.2 GB   │ von 20 GB  │ █░░░░░░░░░░░░░  │ │
│  │ Ollama-Modelle            │  9.8 GB   │ von 50 GB  │ ████░░░░░░░░░░  │ │
│                                                                              │
│  ── Letzte Aktivitäten ──────────────────────────────────────────────────  │
│                                                                              │
│  │ 14:32:15 │ Analyse abgeschlossen  │ doc_127 │ 12.3s │ Ollama        │ │
│  │ 14:31:02 │ PDF hochgeladen        │ doc_127 │       │               │ │
│  │ 14:28:45 │ Feedback gespeichert   │ doc_126 │       │ → RAG #042    │ │
│  │ 14:25:18 │ Analyse abgeschlossen  │ doc_126 │ 14.1s │ Ollama        │ │
│                                                                              │
│  ── Rulesets ────────────────────────────────────────────────────────────  │
│                                                                              │
│  │ 🇩🇪 DE_USTG v1.0.0        │ 11 Merkmale │ Standard                   │ │
│  │ 🇪🇺 EU_VAT v1.0.0         │ 17 Merkmale │ Verfügbar                  │ │
│  │ 🇬🇧 UK_VAT v1.0.0         │ 12 Merkmale │ Verfügbar                  │ │
│                                                                              │
│  [ Health-Check ausführen ]  [ Logs anzeigen ]  [ Cache leeren ]           │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```

### 12.7 Didaktischer Mehrwert

Das Statistik-Dashboard dient im Seminar zur Veranschaulichung von:

| Konzept | Wo sichtbar |
|---------|-------------|
| **Maschinelles Lernen** | RAG-Tab: Anzahl Beispiele, Verbesserung über Zeit |
| **Feedback-Loop** | Feedback-Tab: Wie Korrekturen die Qualität verbessern |
| **Modellvergleich** | Modell-Tab: Unterschiede zwischen Modellen |
| **Ressourcenverbrauch** | Modell-Tab: Token, CPU, RAM, GPU |
| **Fehleranalyse** | Feedback-Tab: Welche Merkmale problematisch sind |

---

## 13. Laufzeit-/Nutzungsstatistik (alle Modelle, Pflicht)
