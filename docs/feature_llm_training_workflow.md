...
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────┐    │
│  │ #   │ Dateiname         │ Status │ Injizierte Fehler              │ Details│    │
│  ├─────────────────────────────────────────────────────────────────────────────┤    │
│  │ 1   │ rechnung_001.pdf  │ ✓ OK   │ -                              │  [👁️]  │    │
│  │ 2   │ rechnung_002.pdf  │ ✗      │ TAX_VAT_RATE_WRONG (7→19)      │  [👁️]  │    │
│  │ 3   │ rechnung_003.pdf  │ ✗      │ PROJECT_PERIOD_BEFORE_START    │  [👁️]  │    │
│  │ 4   │ rechnung_004.pdf  │ ✗      │ FRAUD_SELF_INVOICE             │  [👁️]  │    │
│  │ 5   │ rechnung_005.pdf  │ ✓ OK   │ -                              │  [👁️]  │    │
│  │ 6   │ rechnung_006.pdf  │ ✗      │ TAX_SUPPLY_DATE_MISSING        │  [👁️]  │    │
│  │ 7   │ rechnung_007.pdf  │ ✓ OK   │ -                              │  [👁️]  │    │
│  │ 8   │ rechnung_008.pdf  │ ✗      │ SEMANTIC_RED_FLAG (2 Fehler)   │  [👁️]  │    │
│  └─────────────────────────────────────────────────────────────────────────────┘    │
│                                                                                     │
│  Seite 1 von 50                                    [◀ Zurück] [Weiter ▶]            │
│                                                                                     │
└─────────────────────────────────────────────────────────────────────────────────────┘
```

#### Detail-Ansicht einer generierten Rechnung

```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│  GENERIERTE RECHNUNG: rechnung_002.pdf                                     [✕]      │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                     │
│  ┌───────────────────────────────┐  ┌───────────────────────────────────────────┐   │
│  │                               │  │                                           │   │
│  │      PDF-VORSCHAU             │  │  GENERIERTE WERTE                         │   │
│  │                               │  │  ─────────────────────────────────────    │   │
│  │  ┌─────────────────────────┐  │  │                                           │   │
│  │  │ ┌─────┐ Test AG         │  │  │  invoice_number:   RE-2025-002            │   │
│  │  │ │LOGO │ Teststr. 1      │  │  │  invoice_date:     2025-03-16             │   │
...
│                                                                                     │
├─────────────────────────────────────────────────────────────────────────────────────┤
│  [PDF herunterladen]  [JSON anzeigen]            [◀ Vorherige]  [Nächste ▶]  [Schließen]│
└─────────────────────────────────────────────────────────────────────────────────────┘
```
...
│  └─────────────────────────────────────────────────────────────────────────────┘    │
│                                                                                     │
│  Projekt:        [Training-2025 ▼]                               [+ Neues Projekt]  │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────┐    │
│  │  📋 PROJEKTDATEN (werden für Prüfung verwendet)                             │    │
│  │  ─────────────────────────────────────────────────────────────────────────  │    │
│  │                                                                             │    │
│  │  Projektname:         Förderprojekt Digitalisierung 2025                   │    │
│  │  Projektnummer:       FKZ-2025-12345                                        │    │
│  │  Begünstigter:        Beispiel GmbH                                         │    │
│  │  UST-ID Begünstigter: DE987654321  ← für Selbstrechnungs-Prüfung            │    │
│  │                                                                             │    │
│  │  Bewilligungszeitraum:  01.01.2025 - 31.12.2026                             │    │
│  │  Durchführungszeitraum: 01.04.2025 - 30.11.2025  ← für Datumsprüfung        │    │
│  │  Projektstandort:       Hamburg  ← für Leistungsort-Prüfung                 │    │
│  │                                                                             │    │
│  │  Förderquote:           80%                                                 │    │
│  │  Max. Fördersumme:      250.000 €                                           │    │
│  │                                                                             │    │
│  │  Projektbeschreibung:   ← für semantische Relevanz-Prüfung                  │    │
│  │  "Digitalisierung der Geschäftsprozesse durch ERP-Einführung und           │    │
...
│  [✓] Batch-Ergebnisse in diesem Projekt speichern                                   │
│      → Alle Rechnungen werden dem Projekt zugeordnet                               │
│      → Prüfergebnisse erscheinen im Projekt-Dashboard                              │
