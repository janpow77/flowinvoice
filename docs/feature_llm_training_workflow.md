...
│                                                                                     │
│  Quelle:                                                                            │
│  ● Verzeichnis:  [/data/training/incoming/____________]   [📁 Durchsuchen]          │
│  ○ S3 Bucket:    [___________________________________]                              │
│  ○ Generator:    (Rechnungen automatisch generieren)                                │
│                                                                                     │
│  Lösungsdatei:   [solution.json_____] (im gleichen Verzeichnis)                     │
│                                                                                     │
│  ─────────────────────────────────────────────────────────────────────────────────  │
│                                                                                     │
│  Aktive Kriterien:                                          [Alle ▼] [Verwalten]    │
│  ┌─────────────────────────────────────────────────────────────────────────────┐    │
│  │ [✓] TAX (13 Regeln)                                                         │    │
│  │ [✓] PROJECT (7 Regeln)                                                      │    │
│  │ [✓] FRAUD (5 Regeln)                                                        │    │
│  │ [✓] SEMANTIC (3 Regeln)                                                     │    │
│  │ [✓] ECONOMIC (2 Regeln)                                                     │    │
│  │ [✓] CUSTOM (3 Regeln) ← Neue Kriterien automatisch hinzugefügt             │    │
│  └─────────────────────────────────────────────────────────────────────────────┘    │
│                                                                                     │
│  ─────────────────────────────────────────────────────────────────────────────────  │
│                                                                                     │
│  Nach Abschluss:                                                                    │
│  [✓] Report per E-Mail an: [jan.riener@vwvg.de__________]                           │
│  [✓] Webhook aufrufen:     [______________________________]                         │
│  [✓] Dateien archivieren                                                            │
│  [ ] Dateien löschen (nach erfolgreicher Verarbeitung)                              │
│                                                                                     │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                            [Abbrechen]  [Testen]  [Speichern]       │
└─────────────────────────────────────────────────────────────────────────────────────┘
