...
### Haupt-Layout: Split-View (DocumentReview)
...
├────────────────┬────────────────────────────────┬───────────────────────────────────┤
│                │                                │                                   │
│  BELEGLISTE    │  PDF-VIEWER                    │  KRITERIENKATALOG                 │
│  ────────────  │  ──────────                    │  ─────────────────                 │
│                │                                │                                   │
│  🔍 Suchen...  │  ┌────────────────────────┐    │  📋 DE_USTG (§14 UStG)            │
│                │  │                        │    │                                   │
│  ┌───────────┐ │  │   Mustermann GmbH      │    │  ✓ Eingehalten (12)        [▼]   │
│  │ ● RE-001  │ │  │   Musterstraße 1       │    │  ├ Rechnungsnummer              │
│  │   1.190€  │ │  │   12345 Berlin         │    │  ├ Rechnungsdatum               │
│  │   ✓ OK    │ │  │                        │    │  ├ Lieferantenname              │
│  └───────────┘ │  │   RECHNUNG             │    │  └ ...                          │
│                │  │   Nr. RE-2025-001      │    │                                   │
│  ┌───────────┐ │  │   Datum: 15.03.2025    │    │  ✗ Nicht eingehalten (2)   [▼]   │
│  │   RE-002  │ │  │                        │    │  ┌─────────────────────────────┐ │
│  │   595€    │ │  │   Leistung:            │    │  │ Leistungsort               │ │
│  │   ⚠ Prüf. │ │  │   Beratung März 2025   │    │  │ LLM: Berlin                │ │
│  └───────────┘ │  │                        │    │  │ Erwartet: Hamburg          │ │
│                │  │   Netto:    1.000,00 € │    │  │ [Korrigieren]              │ │
│  ┌───────────┐ │  │   USt 19%:    190,00 € │    │  └─────────────────────────────┘ │
│  │   RE-003  │ │  │   Brutto:   1.190,00 € │    │  ┌─────────────────────────────┐ │
│  │   2.380€  │ │  │                        │    │  │ USt-Satz                   │ │
│  │   ✗ Fehler│ │  └────────────────────────┘    │  │ LLM: 7%                    │ │
│  └───────────┘ │                                │  │ Erwartet: 19%              │ │
│                │  [◀ Seite 1/1 ▶]  [🔍 100%]    │  │ [Korrigieren]              │ │
│  ┌───────────┐ │                                │  └─────────────────────────────┘ │
│  │   RE-004  │ │                                │                                   │
│  │   750€    │ │                                │  ? Nicht gefunden (1)       [▼]   │
│  │   ⏳ Läuft │ │                                │  ┌─────────────────────────────┐ │
│  └───────────┘ │                                │  │ Leistungszeitraum          │ │
│                │                                │  │ Nicht erkannt              │ │
│  ...           │                                │  │ [Nachtragen]               │ │
...
│                │                                │                                   │
├────────────────┴────────────────────────────────┴───────────────────────────────────┤
│  [Lösungsdatei importieren]    [Alle akzeptieren]    [Korrekturen speichern]        │
└─────────────────────────────────────────────────────────────────────────────────────┘
```

### Layout-Details

| Panel | Breite | Funktion |
|-------|--------|----------|
| **Belegliste** | ~250px | Alle Dokumente im Projekt, filterbar, klickbar |
| **PDF-Viewer** | ~40% | Zeigt ausgewählte PDF, zoombar, scrollbar |
| **Kriterienkatalog** | ~40% | Merkmale mit Status, Korrektur-Möglichkeit |

### Belegliste Features

- Suchfeld für Dateinamen/Rechnungsnummer
- Status-Icons: ✓ OK, ⚠️ Prüfung, ✗ Fehler, ⏳ In Bearbeitung
- Betrag-Anzeige
- Aktiver Beleg hervorgehoben
- Scroll für viele Belege

### PDF-Viewer Features

- Lädt von `/api/documents/{id}/file`
- Zoom (50% - 200%)
- Seiten-Navigation
- Fullscreen-Modus (optional)

### Kriterienkatalog Features

- Gruppiert nach Status (eingehalten/nicht eingehalten/nicht gefunden)
- Collapsible Sections
- Inline-Korrektur oder Modal
- Begründungsfeld

---

### Merkmals-Übersicht (Detail)
